          ...
          Column(children: [
            Row(
              ...
              children: [
                ...
                //     setState(() {
                //       listCheckboxForAdd = [];
                //       listCheckboxForDelete = [];
                //       for (var i = 0; i < widget.amenityList.length; i++) {
                //         listCheckbox[widget.amenityList[i]['id'] - 1]
                //             .checkBoxValue = isSelectedAll;
                //       }
                //       // for (var i = 0; i < listCheckbox.length; i++) {
                ...
                //           listCheckboxForDelete.add(
                //               listCheckbox[widget.amenityList[i]['id'] - 1]);
                //         } else if (widget.isdelete == false) {
                //           listCheckboxForAdd.add(
                //               listCheckbox[widget.amenityList[i]['id'] - 1]);
                //         }
                //       }
                //       isSelectedAll = !isSelectedAll;
                //       debugPrint(listCheckboxForAdd.length.toString());
                //     });
                //   },
                //   child: RichText(
                //     text: TextSpan(
