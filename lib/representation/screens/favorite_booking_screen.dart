...
class FavoriteBookingScreen extends StatefulWidget {
  const FavoriteBookingScreen({super.key, this.useImplementLeading = true});

  static const String routeName = '/favorite_booking_screen';

  final bool useImplementLeading;

  @override
  State<FavoriteBookingScreen> createState() => _FavoriteBookingScreenState();
}

class _FavoriteBookingScreenState extends State<FavoriteBookingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    _distanceInfo = args['distanceInfo'];
            ...
            child: ButtonWidget(
              ...
              ontap: () {
                if (_dateSelected == null) {
                  ...
                  NavigationUtils.navigate(context, HotelDetailScreen.routeName,
                      arguments: {
                        "hotelId": id,
