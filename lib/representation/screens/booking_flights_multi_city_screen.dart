...
class BookingFlightsMultiCityScreen extends StatefulWidget {
  const BookingFlightsMultiCityScreen({Key? key}) : super(key: key);

  static const String routeName = '/booking_flights_multi_city_screen';

  @override
  State<BookingFlightsMultiCityScreen> createState() =>
      _BookingFlightsMultiCityScreenState();
}

class _BookingFlightsMultiCityScreenState
    extends State<BookingFlightsMultiCityScreen> {
  @override
