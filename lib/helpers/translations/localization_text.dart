...
class LocalizationText {
  ...
  static String orLoginWith = "orLoginWith".tr();
  static String email = "email".tr();
  static String password = "password".tr();
  static String passwordConfirm = "passwordConfirm".tr();
...
//filter flight screen
  ...
  static String pleaseRate = "please_rate".tr();
  static String yourComment = "your_comment".tr();
}
